...
export default {
  ...
  data() {
    return {
      Skills: [
        {
          DarkImage: "../../assets/Logos/JavaScript-logo.png",
          LightImage: "../../assets/Logos/JavaScript-logo.png",
          alt: "js-Logo",
          title: "JavaScript",
          description:
        ...
        {
          DarkImage: "../../assets/Logos/vue-js-Dark.png",
          LightImage:"../../assets/Logos/vue-js-light.png",
          alt: "Vue-Logo",
          title:"Vue",
          description:
        ...
        {
          DarkImage: "../../assets/Logos/JQuery-dark.jpg",
          LightImage:"../../assets/Logos/JQuery-light.jpg",
          alt: "JQuery-Logo",
          title:"jQuery",
          description:
        ...
        {
          DarkImage: "../../assets/Logos/Bootstrap-dark.jpg",
          LightImage:"../../assets/Logos/Bootstrap-light.jpg",
          alt: "Bootstrap-Logo",
          title:"Bootstrap",
          description:
        ...
        {
          DarkImage: "../../assets/Logos/Tailwind-dark.jpg",
          LightImage:"../../assets/Logos/Tailwind-light.jpg",
          alt: "Tailwind-Logo",
          title:"Tailwind",
          description:
        ...
        {
          DarkImage: "../../assets/Logos/Sass_logo-dark.png",
          LightImage:"../../assets/Logos/Sass_logo-light.png",
          alt: "Sass-Logo",
          title:"Sass",
          description:
            "Tailwind CSS یک “utility-first” فریم‌ورک CSS است که ابزارها و class‌های پر استفاده CSS را در اختیار شما قرار می‌دهد و می‌توانید به آسانی به کمک آن وبسایت یا برنامه‌تان را استایل‌دهی کنید، البته هدف اساسی این فریم‌ورک آن است که نخواهید با استایل‌های CSS سروکله بزنید و ده‌ها بار یک selector را override کنید.",
        ...
        {
          DarkImage: "../../assets/Logos/Docker-Dark.jpg",
          LightImage:"../../assets/Logos/Docker-Light.jpg",
          alt: "Docker-Logo",
          title:"Docker",
          description:
        ...
        {
          DarkImage: "../../assets/Logos/git-dark.jpg",
          LightImage:"../../assets/Logos/git-light.jpg",
          alt: "git-Logo",
          title:"git",
          description:
