...
data(){
  return{
    MyProjects:[
      {id:1 , name:"Golden Movie" , img:"https://i.imgur.com/JaHEE06.png" , address:"https://golden-movie-tau.vercel.app/",pages:["LogIn","خانه","توضیحات فیلم"],area:"یک سایت برای دانلود فیلم و سریال است  " , techs:"JavaScript ،Vite ، Vue js ، Sass ، Bootstrap"  }
    ]
