...
data(){
  return{
    MyProjects:[
      {id:1 , name:"Golden Movie" , img:"../../assets/images/GoldenMovie.png" , address:"https://golden-movie-tau.vercel.app/",pages:["LogIn","خانه","توضیحات فیلم"],area:"یک سایت برای دانلود فیلم و سریال است  " , techs:"JavaScript ،Vite ، Vue js ، Sass ، Bootstrap"  }
    ]
